...
class BGAN:
    model_name = "BGAN"
    paper_name = "Boundary Seeking GAN (边界寻找对抗生成网络)"
    paper_url = "https://www.jianshu.com/p/e51c22d02871"
    ...
    def discriminator(self, inputs):
        with tf.variable_scope("discriminator", reuse=tf.AUTO_REUSE):
            ...
            out = tf.layers.dense(x, 1, tf.nn.sigmoid, name='x_3')
        return out
    ...
    def build_model(self, learning_rate=0.0002):
        ...
        g_loss = 0.5 * tf.reduce_mean(tf.square((tf.log(d_logit_fake) - tf.log(1 - d_logit_fake))))
